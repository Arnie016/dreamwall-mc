...
def draw_icon(kind, color, shape, variant):
    ...
    if kind == "earbuds":
        ...
        glass = blend(mid, (174, 230, 244), 0.56)
        water = blend(mid, (60, 178, 226), 0.5)
        px(d, (7, 1, 9, 2), shade(mid, -18))
        px(d, (6, 3, 10, 4), light)
        px(d, (5, 5, 11, 14), glass)
        px(d, (6, 8, 10, 13), water)
        px(d, (6, 7, 10, 8), (242, 245, 232))
        px(d, (7, 6, 9, 6), blend(light, (255, 255, 255), 0.52))
        px(d, (10, 5, 11, 12), blend(light, (255, 255, 255), 0.44))
        px(d, (6, 14, 10, 15), shade(mid, -48))
    elif shape == "phone":
        screen = blend(mid, (42, 132, 188), 0.48)
        px(d, (4, 1, 12, 15), ink)
        px(d, (5, 2, 11, 14), screen)
        px(d, (6, 3, 10, 5), blend(screen, (70, 190, 235), 0.42))
        for ix, x in enumerate((6, 8, 10)):
            for iy, y in enumerate((7, 9, 11)):
                app = [accent, (246, 214, 92), (120, 220, 160), (238, 112, 112)][(ix + iy + variant) % 4]
                px(d, (x, y, x, y), app)
        px(d, (7, 13, 9, 13), dark)
        px(d, (10, 2, 11, 3), shade(ink, 40))
        px(d, (10, 3, 10, 3), light)
        px(d, (3, 6, 3, 8), dark)
    elif shape == "sticker":
        paper = blend(mid, (255, 255, 248), 0.68)
        px(d, (3, 4, 13, 12), paper)
        px(d, (4, 5, 11, 11), blend(paper, (246, 246, 236), 0.35))
        px(d, (5, 6, 7, 8), accent)
        px(d, (8, 6, 10, 6), ink)
        px(d, (8, 8, 11, 9), blend(accent, (70, 220, 180), 0.36))
        px(d, (11, 10, 13, 12), shade(paper, -42))
        px(d, (12, 11, 13, 12), (255, 255, 255, 0))
        px(d, (12, 10, 13, 10), light)
    elif shape == "lamp":
        ...
        belly = blend(light, (244, 210, 170), 0.5)
        px(d, (5, 7, 11, 13), mid)
        px(d, (5, 4, 11, 9), light)
        px(d, (3, 8, 5, 11), mid)
        px(d, (11, 8, 13, 11), mid)
        ...
        px(d, (11, 3, 12, 5), mid)
        px(d, (5, 4, 5, 4), belly)
        px(d, (11, 4, 11, 4), belly)
        px(d, (6, 9, 10, 13), belly)
        px(d, (7, 7, 7, 7), ink)
        px(d, (9, 7, 9, 7), ink)
        px(d, (8, 8, 8, 9), shade(ink, 28))
        px(d, (6, 14, 7, 15), dark)
        px(d, (9, 14, 10, 15), dark)
    elif shape == "brush":
...
def element_model(shape, texture_ref, variant):
    ...
    shape_elements = {
        ...
        "bottle": [([5, 4, 5], [11, 14, 10]), ([6, 2, 6], [10, 4, 9]), ([6, 8, 4], [10, 10, 5]), ([9, 5, 4], [10, 12, 5])],
        "phone": [([4, 2, 6], [12, 15, 8]), ([5, 3, 5], [11, 14, 6]), ([6, 7, 4], [7, 8, 5]), ([9, 7, 4], [10, 8, 5]), ([10, 2, 4], [12, 4, 6])],
        "sticker": [([3, 4, 6], [13, 12, 7]), ([5, 6, 5], [8, 9, 6]), ([9, 7, 5], [12, 9, 6]), ([11, 10, 5], [13, 12, 8])],
        ...
        "plush": [([5, 6, 5], [11, 13, 10]), ([5, 3, 5], [11, 8, 10]), ([3, 3, 6], [5, 5, 9]), ([11, 3, 6], [13, 5, 9]), ([3, 8, 6], [5, 11, 9]), ([11, 8, 6], [13, 11, 9]), ([6, 13, 6], [8, 15, 9]), ([9, 13, 6], [11, 15, 9])],
